...
export default class Resource extends MatterEntity {
    static preload(scene) {
        scene.load.atlas('nature_resources', '../assets/Atlas/nature_resources/original/nature_resources.png', '../assets/Atlas/nature_resources/original/nature_resources_atlas.json')
